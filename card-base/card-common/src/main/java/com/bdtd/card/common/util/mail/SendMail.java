 ...
 * 
 */
package com.bdtd.card.common.util.mail;
...
//		Security.addProvider(new com.sun.net.ssl.internal.ssl.Provider());
	...
	public static void sendDefault(String message) {
		String host = "smtp.sina.com";
		String username = "18513858788@sina.cn";
		String password = "ASDll7582596$";
		MailInfo mailInfo = new MailInfo("18513858788@sina.cn", new StringBuilder("1486280807@qq.com"), null, null, "实时股票", message, null);
		try {
			send(host, username, password, mailInfo);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
