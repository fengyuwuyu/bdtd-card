package com.bdtd.card.data.consume.config.properties;
...
public class DbProperties {
	...
	public String toString() {
		return "DbProperties [url=" + url + ", username=" + username + ", password=" + password + ", driverClassName="
				+ driverClassName + ", initialSize=" + initialSize + ", minIdle=" + minIdle + ", maxActive=" + maxActive
