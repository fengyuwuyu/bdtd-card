...
import com.bdtd.card.socket.base.invoke.AbstractClientInvoke;
import com.card.socket.api.login.command.LoginRequest;

@InvokeClass(module=BdtdModule.LOGIN, name="LoginService", couple=LoginServer.class)
public class LoginClient extends AbstractClientInvoke {

	public void login(Integer nodeId, AsyncCallback<String> callback) {
		this.invoke(LoginRequest.class, callback, nodeId);
	}
