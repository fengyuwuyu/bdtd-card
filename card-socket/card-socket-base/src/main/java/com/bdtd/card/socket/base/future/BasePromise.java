...
public class BasePromise<V> extends AbstractFuture<V> implements Promise<V> {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(BasePromise.class);
    private static final InternalLogger rejectedExecutionLogger =
            InternalLoggerFactory.getInstance(BasePromise.class.getName() + ".rejectedExecution");
    private static final int MAX_LISTENER_STACK_DEPTH = Math.min(8,
            SystemPropertyUtil.getInt("io.netty.defaultPromise.maxListenerStackDepth", 8));
    @SuppressWarnings("rawtypes")
    private static final AtomicReferenceFieldUpdater<BasePromise, Object> RESULT_UPDATER =
            AtomicReferenceFieldUpdater.newUpdater(BasePromise.class, Object.class, "result");
    private static final Object SUCCESS = new Object();
    private static final Object UNCANCELLABLE = new Object();
    private static final CauseHolder CANCELLATION_CAUSE_HOLDER = new CauseHolder(ThrowableUtil.unknownStackTrace(
            new CancellationException(), BasePromise.class, "cancel(...)"));
    ...
    private void addListener0(GenericFutureListener<? extends Future<? super V>> listener) {
        if (listeners == null) {
            ...
            listeners = new BasePromiseListeners((GenericFutureListener<?>) listeners, listener);
        }
    }
    ...
    private synchronized Object progressiveListeners() {
        ...
        if (listeners instanceof BasePromiseListeners) {
            // Copy BasePromiseListeners into an array of listeners.
            BasePromiseListeners dfl = (BasePromiseListeners) listeners;
